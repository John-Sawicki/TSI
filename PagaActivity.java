...
public class PagaActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener{
    ...
    private static String ACTIVITY ="Paga_Activity", SPEAKER_KEY = "SpeakerLevel";
    private int mPower=0;//when -1 the value has not been entered by the used even after screen rotation
    double interferenceCo = 2, unifCo =1;//1 for ft and 0.3048 for meters
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this,
                R.array.interference,android.R.layout.simple_spinner_item );
        ...
        sp_source_voltage.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                interferenceCo = determineInterference(i); Log.d(ACTIVITY,"interferenceCo spinner"+ interferenceCo);
            }
            @Override
        ...
        setUpPreferences();//updates tv_distance_uom
        if(savedInstanceState!=null){//valued saved on rotate
            Log.d(ACTIVITY, "savedInstanceState!=null");
            mPower = savedInstanceState.getInt(SPEAKER_KEY);
            Log.d(ACTIVITY, "speaker power onCreate "+mPower);
            colorCircles(); //if a value was saved on rotate, color the circles back in
        }
    ...
    private void updateUnitText() {
        if (imperial) {
            tv_distance_uom.setText(getResources().getString(R.string.distance_ft));
            uomString ="ft";   unifCo =1;
        } else{
            tv_distance_uom.setText(getResources().getString(R.string.distance_m));
            uomString ="m"; unifCo = 0.3048;
        }
    }
    @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(itemClicked==R.id.shared_pref){
            ...
            startActivity(new Intent(PagaActivity.this, MainActivity.class));
            return true;
        }
        return super.onOptionsItemSelected(item);
    }
    private void colorCircles(){
       int speakerPower = mPower;
        if(speakerPower<=0){
            ...
            double spl = 118+10*Math.log10(mPower);Log.d("paga1 spl", spl+"");
            ...
            if(mPower>300){Log.d(ACTIVITY,"mPower>300 text values");
                tv_db_level1.setText(R.string.one_hundred_ten_db);  Log.d(ACTIVITY,"interferenceCo circle "+ interferenceCo);
                dbDistance1 = (2/ interferenceCo)*Math.round( unifCo*sqrt(  pow(10, ((spl-110)/10) ) /(4*3.14159) ));
                ...
                dbDistance2 = (2/ interferenceCo)*Math.round( unifCo*sqrt(  pow(10, ((spl-100)/10) ) /(4*3.14159) ));
                stringDist2 = ""+(int)dbDistance2;  tv_distance2.setText(stringDist2);
                tv_db_level3.setText(R.string.ninety_db);
                dbDistance3 = (2/ interferenceCo)*Math.round( unifCo*sqrt(  pow(10, ((spl-90)/10) ) /(4*3.14159) ));
                stringDist3 = ""+(int)dbDistance3;  tv_distance3.setText(stringDist3);
                tv_db_level4.setText(R.string.eighty_db);
                dbDistance4 = (2/ interferenceCo)*Math.round( unifCo*sqrt(  pow(10, ((spl-80)/10) ) /(4*3.14159) ));
                stringDist4 = ""+(int)dbDistance4;      tv_distance4.setText(stringDist4);
                tv_db_level5.setText(R.string.seventy_db);
                dbDistance5 = (2/ interferenceCo)*Math.round( unifCo*sqrt(  pow(10, ((spl-70)/10) ) /(4*3.14159) ));
                stringDist5 = ""+(int)dbDistance5;      tv_distance5.setText(stringDist5);
                tv_db_level6.setText(R.string.sixty_db);
                dbDistance6 = (2/ interferenceCo)*Math.round( unifCo*sqrt(  pow(10, ((spl-60)/10) ) /(4*3.14159) ));
            ...
            if(mPower>50&&mPower<=300){ Log.d(ACTIVITY,"mPower>50&&mPower<=300 text values");
                ...
                dbDistance1 = (2/ interferenceCo)*Math.round( unifCo*sqrt(  pow(10, ((spl-100)/10) ) /(4*3.14159) ));
                stringDist1 = ""+(int)dbDistance1;      tv_distance1.setText(stringDist1);
                tv_db_level2.setText(R.string.ninety_db);
                dbDistance2 = (2/ interferenceCo)*Math.round( unifCo*sqrt(  pow(10, ((spl-90)/10) ) /(4*3.14159) ));
                stringDist2 = ""+(int)dbDistance2;      tv_distance2.setText(stringDist2);
                tv_db_level3.setText(R.string.eighty_db);
                dbDistance3 = (2/ interferenceCo)*Math.round( unifCo*sqrt(  pow(10, ((spl-80)/10) ) /(4*3.14159) ));
                stringDist3 = ""+(int)dbDistance3;      tv_distance3.setText(stringDist3);
                tv_db_level4.setText(R.string.seventy_db);
                dbDistance4 = (2/ interferenceCo)*Math.round( unifCo*sqrt(  pow(10, ((spl-70)/10) ) /(4*3.14159) ));
                stringDist4 = ""+(int)dbDistance4;      tv_distance4.setText(stringDist4);
                tv_db_level5.setText(R.string.sixty_db);
                dbDistance5 = (2/ interferenceCo)*Math.round( unifCo*sqrt(  pow(10, ((spl-60)/10) ) /(4*3.14159) ));
                stringDist5 = ""+(int)dbDistance5;      tv_distance5.setText(stringDist5);
                tv_db_level6.setText(R.string.fifty_db);
                dbDistance6 = (2/ interferenceCo)*Math.round( unifCo*sqrt(  pow(10, ((spl-50)/10) ) /(4*3.14159) ));
                stringDist6 = ""+(int)dbDistance6;      tv_distance6.setText(stringDist6);
                widgetDistance = stringDist6;
            }if(mPower>0&&mPower<=50){  Log.d(ACTIVITY,"mPower>0&&mPower<=50 text values");
                tv_db_level1.setText(R.string.ninety_db);
                dbDistance1 = (2/ interferenceCo)*Math.round( unifCo*sqrt(  pow(10, ((spl-90)/10) ) /(4*3.14159) ));
                stringDist1 = ""+(int)dbDistance1;      tv_distance1.setText(stringDist1);
                tv_db_level2.setText(R.string.eighty_db);
                dbDistance2 = (2/ interferenceCo)*Math.round( unifCo*sqrt(  pow(10, ((spl-80)/10) ) /(4*3.14159) ));
                stringDist2 = ""+(int)dbDistance2;      tv_distance2.setText(stringDist2);
                tv_db_level3.setText(R.string.seventy_db);
                dbDistance3 = (2/ interferenceCo)*Math.round( unifCo*sqrt(  pow(10, ((spl-70)/10) ) /(4*3.14159) ));
                stringDist3 = ""+(int)dbDistance3;      tv_distance3.setText(stringDist3);
                tv_db_level4.setText(R.string.sixty_db);
                dbDistance4 = (2/ interferenceCo)*Math.round( unifCo*sqrt(  pow(10, ((spl-60)/10) ) /(4*3.14159) ));
                stringDist4 = ""+(int)dbDistance4;      tv_distance4.setText(stringDist4);
                tv_db_level5.setText(R.string.fifty_db);
                dbDistance5 = (2/ interferenceCo)*Math.round( unifCo*sqrt(  pow(10, ((spl-50)/10) ) /(4*3.14159) ));
                stringDist5 = ""+(int)dbDistance5;      tv_distance5.setText(stringDist5);
                tv_db_level6.setText(R.string.forty_db);
                dbDistance6 = (2/ interferenceCo)*Math.round( unifCo*sqrt(  pow(10, ((spl-40)/10) ) /(4*3.14159) ));
                stringDist6 = ""+(int)dbDistance6;      tv_distance6.setText(stringDist6);
                widgetDistance = stringDist6;
            }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putInt(SPEAKER_KEY,mPower);
    }
    @Override
    public void onPause() {
